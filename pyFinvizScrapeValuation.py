...
print "Finviz Valuation Start"
url = "http://www.finviz.com/screener.ashx?v=121&f=geo_usa"
...
while(currentpage > 0):
    ...
    secondurl = "http://www.finviz.com/screener.ashx?v=" + str(121) + "&f=geo_usa" + "&r=" + str(currentpage)
