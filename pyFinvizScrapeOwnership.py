...
print "Finviz Ownership Start"
url = "http://www.finviz.com/screener.ashx?v=131&f=geo_usa"
...
while(currentpage > 0):
    ...
    secondurl = "http://www.finviz.com/screener.ashx?v=" + str(131) + "&f=geo_usa" + "&r=" + str(currentpage)
